...
@Entity
@Data
@Table(name = "dn_task_public_material")
@org.hibernate.annotations.Table(appliesTo = "dn_task_public_material", comment = "公共服务类事项 材料信息")
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class DnTaskPublicMaterial {
    @Id
