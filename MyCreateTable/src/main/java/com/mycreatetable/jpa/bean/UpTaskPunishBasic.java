...
@Entity
@Data
@Table(name = "up_task_punish_basic")
@org.hibernate.annotations.Table(appliesTo = "up_task_punish_basic", comment = "处罚类事项 基本信息")
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class UpTaskPunishBasic {
    ...
    @Column(name = "use_level", columnDefinition = "varchar(2) comment '行使层级'", nullable = false)
    private String useLevel;

    @Column(name = "task_code", columnDefinition = "varchar(36) comment '实施编码'", nullable = false)
    private String taskCode;

    @Column(name = "local_task_code", columnDefinition = "varchar(50) comment '地方实施编码'", nullable = false)
    ...
    @Column(name = "punishment_method", columnDefinition = "varchar(3000) comment '处罚的行为、种类、幅度'", nullable = false)
