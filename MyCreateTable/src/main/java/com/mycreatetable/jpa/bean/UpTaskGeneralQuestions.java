...
@Entity
@Data
@Table(name = "up_task_general_questions")
@org.hibernate.annotations.Table(appliesTo = "up_task_general_questions", comment = "许可、给付、奖励、确认、裁决、其他类事项 常见问题解答")
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class UpTaskGeneralQuestions {
