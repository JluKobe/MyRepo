...
@Entity
@Data
@Table(name = "up_task_handle_material")
@org.hibernate.annotations.Table(appliesTo = "up_task_handle_material", comment = "征收类事项 材料目录信息")
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class UpTaskHandleMaterial {
