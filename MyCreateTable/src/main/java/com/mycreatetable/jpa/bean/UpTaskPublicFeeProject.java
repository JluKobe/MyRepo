...
@Entity
@Data
@Table(name = "up_task_public_fee_project")
@org.hibernate.annotations.Table(appliesTo = "up_task_public_fee_project", comment = "公共服务类事项 收费项目信息")
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class UpTaskPublicFeeProject {
