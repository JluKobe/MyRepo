...
@org.hibernate.annotations.Table(appliesTo = "dn_task_punish_basic", comment = "处罚类事项 基本信息")
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class DnTaskPunishBasic {
    @Id
    ...
    @Column(name = "plan_effective_data", columnDefinition = "datetime comment '计划生效日期'")
