...
@Entity
@Data
@Table(name = "dn_task_public_basic")
@org.hibernate.annotations.Table(appliesTo = "dn_task_public_basic", comment = "公共服务类事项 基本信息")
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class DnTaskPublicBasic {
    @Id
    ...
    @Column(name = "promise_type", columnDefinition = "int(2) comment '承诺办结时限单位'")
