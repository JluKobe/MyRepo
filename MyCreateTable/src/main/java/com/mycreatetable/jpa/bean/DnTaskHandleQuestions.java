...
@Entity
@Data
@Table(name = "dn_task_handle_questions")
@org.hibernate.annotations.Table(appliesTo = "dn_task_handle_questions", comment = "征收类事项 常见问题解答")
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class DnTaskHandleQuestions {
    @Id
