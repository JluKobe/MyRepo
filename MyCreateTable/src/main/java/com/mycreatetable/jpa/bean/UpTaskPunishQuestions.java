...
@Entity
@Data
@Table(name = "up_task_punish_questions")
@org.hibernate.annotations.Table(appliesTo = "up_task_punish_questions", comment = "处罚类事项 常见问题解答")
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class UpTaskPunishQuestions {
