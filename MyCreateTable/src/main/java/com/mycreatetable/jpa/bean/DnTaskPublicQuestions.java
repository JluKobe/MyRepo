...
@Entity
@Data
@Table(name = "dn_task_public_questions")
@org.hibernate.annotations.Table(appliesTo = "dn_task_public_questions", comment = "公共服务类事项 常见问题解答")
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class DnTaskPublicQuestions {
    @Id
