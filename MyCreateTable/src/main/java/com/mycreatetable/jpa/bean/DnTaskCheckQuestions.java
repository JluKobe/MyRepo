...
@Entity
@Data
@Table(name = "dn_task_check_questions")
@org.hibernate.annotations.Table(appliesTo = "dn_task_check_questions", comment = "强制、检查类事项 常见问题解答")
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class DnTaskCheckQuestions {
    @Id
