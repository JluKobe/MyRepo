...
@Entity
@Data
@Table(name = "up_task_public_extend")
@org.hibernate.annotations.Table(appliesTo = "up_task_public_extend", comment = "公共服务类事项 扩展信息")
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class UpTaskPublicExtend {
    ...
    @Column(name = "result_type", columnDefinition = "varchar(2) comment '审批结果类型'", nullable = false)
