...
public class IgtTaskBasic {
    ...
    @Column(name = "result_type", columnDefinition = "varchar(50) comment '事项结构类型'")
    private String resultType;

    @Column(name = "result_sample", columnDefinition = "varchar(200) comment '审批结果样本'")
    private String resultSample;

    @Column(name = "accept_center_code", columnDefinition = "varchar(256) comment '受理中心编号'")
    private String acceptCenterCode;

    @Column(name = "is_fee", columnDefinition = "varchar(2) comment '是否收费'")
    private String isFee;

    @Column(name = "fee_basis", columnDefinition = "longtext comment '收费依据'")
    private String feeBasis;

    @Column(name = "area_code", columnDefinition = "varchar(50) comment '区域码'")
    private String areaCode;

    @Column(name = "chg_type_list", columnDefinition = "varchar(256) comment '使用渠道 C01综窗 C02网厅 C03网厅移动端app T99三方渠道'")
